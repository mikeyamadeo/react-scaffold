...
* [CSSNext](http://cssnext.io/) + [CSSModules](http://glenmaddern.com/articles/css-modules) - Global
* ES6, React - CSS in js ftw
...
.img {
  float: left;
  marginRight: var(--spacing-standard);
}
