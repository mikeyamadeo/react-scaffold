var html = require('./html-generator');
...
HJSPlugin.prototype.apply = function (compiler) {
  var self = this
  var htmlFunction = this.config.isDev ? html.dev : html.prod
  
  //Require html to be generated dynamically for production
  if (!this.config.htmlConfig) {
  	throw new Error('No htmlConfig provided')
  }
  ...
  compiler.plugin('emit', function (compiler, callback) {
    ...
    assets.htmlConfig = self.config.htmlConfig
